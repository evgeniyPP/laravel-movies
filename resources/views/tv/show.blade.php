...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $tvshow['poster'] }}" alt="poster" class="w-64 md:w-96">
            </div>
            <div class="md:ml-24">
                    ...
                    <div class="mt-12">
                        <div class="flex flex-wrap mt-4">
                            @foreach ($tvshow['created_by'] as $crew)
                                <div class="mr-8">
                                    <div>{{ $crew['name'] }}</div>
                                    <div class="text-sm text-gray-400">Создатель</div>
                                </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <div class="tv-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Актерский состав</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($tvshow['cast'] as $actor)
                    <div class="mt-8">
                        <a href="{{ route('actors.show', $actor['id']) }}">
                            <img src="https://image.tmdb.org/t/p/w300/{{ $actor['profile_path'] }}" alt="cast member" onerror="(function(e){e.src = '/img/no-avatar.jpg';})(this)" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="mt-2">
