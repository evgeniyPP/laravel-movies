...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $actor['image'] }}" alt="profile image" class="w-76">
                <ul class="flex items-center mt-4">
                    @if ($social['facebook'])
                        <li>
                            <a href="{{ $social['facebook'] }}" title="Facebook" target="_blank" rel="noopener noreferrer">
                    ...
                    @if ($social['instagram'])
                        <li class="ml-6">
                            <a href="{{ $social['instagram'] }}" title="Instagram" target="_blank" rel="noopener noreferrer">
                    ...
                    @if ($social['twitter'])
                        <li class="ml-6">
                            <a href="{{ $social['twitter'] }}" title="Twitter" target="_blank" rel="noopener noreferrer">
                    ...
                    @if ($actor['homepage'])
                        <li class="ml-6">
                            <a href="{{ $actor['homepage'] }}" title="Веб-сайт" target="_blank" rel="noopener noreferrer">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-1">{{ $actor['birthday'] }} ({{ $actor['age'] }} лет) в {{ $actor['place_of_birth'] }}</span>
                </div>
                ...
                <h4 class="font-semibold mt-12">{{ $actor['isFemale'] ? 'Известна за' : 'Известен за' }}</h4>
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Фильмография</h2>
